...
let favoriteFoods = ['pizza', 'spaghetti', 'steak', 'chicken wings'];
...
console.log ('Via array length, last animal is', animalArray[animalArray.length - 1]);
...
console.log ('Removed the last food,', removedFood + ".... sad");
...
console.log ("The updated food list is:", favoriteFoods);

// 4.e (STRETCH) TODO: Replace the second food in your array
//      with another one of your favorite foods.
//      Then log the updated array.
favoriteFoods[1] = 'lasagna';
console.log ('Changed my second favorite food:',favoriteFoods);
